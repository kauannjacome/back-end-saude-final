...
async function main() {
    ...
    await prisma.regulation.create({
        data: {
            ...
            status: 'recebido',
            scheduled_date: (0, dayjs_1.default)().add(5, 'day').toDate(),
    ...
    await prisma.regulation.create({
        data: {
            subscriber_id: subscriberId,
            status: 'recebido',
            scheduled_date: (0, dayjs_1.default)().add(10, 'day').toDate(),
    ...
    await prisma.regulation.create({
        data: {
            ...
            status: 'em_andamento',
            priority: 'urgencia',
            created_at: (0, dayjs_1.default)().subtract(15, 'day').toDate(),
    ...
    await prisma.regulation.create({
        data: {
            ...
            status: 'em_andamento',
            priority: 'urgencia',
            created_at: (0, dayjs_1.default)().subtract(10, 'day').toDate(),
